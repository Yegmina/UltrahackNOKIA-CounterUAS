...
$App = Join-Path $PSScriptRoot "android_thermovue_bridge_probe"
...
Invoke-Native @($Apksigner, "sign", "--ks", $Keystore, "--ks-pass", "pass:android", "--key-pass", "pass:android", "--out", (Join-Path $Build "thermovue-bridge-probe.apk"), (Join-Path $Build "aligned.apk"))
Invoke-Native @($Apksigner, "verify", (Join-Path $Build "thermovue-bridge-probe.apk"))

Write-Host "Built $Build\thermovue-bridge-probe.apk"
